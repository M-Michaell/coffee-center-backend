...
class Product(models.Model):
    ...
    coffee_type = models.ForeignKey(CoffeeType, on_delete=models.CASCADE, related_name="product_coffe_type" , null=True, default=None)
...
class Rate(models.Model):
    ...
    def __str__(self):
        return f"{self.user.username} rated {self.product.name} with {self.rate} stars"